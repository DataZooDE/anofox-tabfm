...
void RegisterCrossValidateMacros(ExtensionLoader &loader) {
	...
	// tabfm_compare_models (CMP-01) is deferred to Phase 2: it hardcodes
	// tabpfn_v2 and tabfm-v1 model family names which do not exist on main.
	// Re-enable once the model registry supports listing available families
	// (planned for Phase 2 / M3 engine integration).
}
