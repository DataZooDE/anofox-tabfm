# anofox-tabfm overlay: vcpkg's registry onnx port tops out at 1.19.0, but
# onnxruntime 1.28.0 (see ../onnxruntime) needs the TensorProto_DataType_INT2 /
# _UINT2 enumerators and OpSchema::SetNodeDeterminism() that only land in onnx
# 1.20+; upstream ORT's cmake/deps.txt pins exactly 1.22.0, so we do too.
# Based on vcpkg's own ports/onnx (last synced 2025-12-27, onnx@1.19.0);
