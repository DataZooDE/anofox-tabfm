...
- [x] **Phase 3: Proper Scoring Rules + Cross-Model Comparison** - Distribution-gated CRPS / log-score / interval score and evaluation across model families on user tables (completed 2026-09-22)
...
- [x] 02-04-PLAN.md — Per-family license gate + end-to-end distribution predict vs golden (MODL-03)
...
- [x] 03-01-PLAN.md — Tracer + scaffold: `tabfm_crps` fully end-to-end (STRUCT-read, non-uniform CRPS math, PSR-04 bind-gate, golden test) + coordinated scoring-module scaffold (PSR-01, PSR-04)
- [x] 03-02-PLAN.md — Expansion + comparison: `tabfm_log_score` (PSR-02), `tabfm_interval_score` (PSR-03), and `tabfm_compare_models` cross-model macro (CMP-01)
...
| 3. Proper Scoring Rules + Cross-Model Comparison | 2/2 | Complete    | 2026-09-22 |
